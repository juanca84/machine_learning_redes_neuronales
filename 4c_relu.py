# Diplomado Machine Learning - Módulo Redes Neuronales
# autor:  Juan Carlos Condori Machicado
# version: V0.0.1
# version python: 3.6
...
for t in range(max_epoch):
    ...
    grad_w3 = A3.T.dot(grad_a_4*dRelu(A4))

    grad_a_3 = grad_a_4.dot(w3.T)
    grad_w2 = A2.T.dot(grad_a_3*dRelu(A3))

    grad_a_2 = grad_a_3.dot(w2.T)
    grad_w1 = x.T.dot(grad_a_2*dRelu(A2))
